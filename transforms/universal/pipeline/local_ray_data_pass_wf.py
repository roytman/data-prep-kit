...
def doc_id(output_folder: Output[Artifact]):
    import os
    import sys
...
def ededup(input_folder: Input[Artifact], output_folder: Output[Artifact]):
    import os
    import sys
...
def fdedup(input_folder: Input[Artifact], output_folder: Output[Artifact]):
    import os
    import sys
...
def test_pipeline():
    doc_id()
    ededup(doc_id.outputs["output_folder"].path)
    fdedup(ededup.outputs["output_folder"].path)
    print(f"The output data is at {fdedup.outputs['output_folder'].path}")
